...
class AppLocalizations {
  ...
  static final Map<String, Map<String, String>> _localizedValues = {
    'en': {
      ...
      'paywall_premium_header': 'TıpAkademi Premium',
      ...
      'onboarding_slide1_title': 'Welcome to TıpAkademi',
      ...
      'medical_disclaimer': 'TıpAkademi is an educational language model, not a certified clinical tool, and cannot provide official medical advice or diagnostic prescriptions.',
    ...
    'tr': {
      ...
      'onboarding_slide1_title': 'TıpAkademi\'a Hoş Geldiniz',
      ...
      'medical_disclaimer': 'TıpAkademi eğitsel bir dil modelidir, sertifikalı bir klinik araç değildir ve resmi tıbbi tavsiye veya teşhis reçetesi sağlayamaz.',
